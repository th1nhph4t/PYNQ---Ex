...
HD_PWD='C:/Users/phat6/OneDrive/Desktop/testnaykia/vivado/per/GPIO_LED/GPIO_LED.runs/gpio_led_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_led_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_led_axi_gpio_0_0.tcl
