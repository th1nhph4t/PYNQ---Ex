...
HD_PWD='C:/Users/phat6/OneDrive/Desktop/testnaykia/vivado/per/GPIO_LED/GPIO_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_led_wrapper.tcl -notrace
