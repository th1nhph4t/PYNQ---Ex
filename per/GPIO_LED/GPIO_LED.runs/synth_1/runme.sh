...
HD_PWD='C:/Users/phat6/OneDrive/Desktop/testnaykia/vivado/per/GPIO_LED/GPIO_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_led_wrapper.tcl
