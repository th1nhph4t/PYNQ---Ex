...
set xo_kernel_name "lc3"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/LVTN/lc3/lc3_isa/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "D:/LVTN/lc3/lc3_isa/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {lc3_reg_r_RAM_AUTO_1R1W
lc3_memory_RAM_AUTO_1R1W
lc3_control_s_axi
lc3
}
set kernel_xo ""
set detect_deadlock_json "lc3_message_dict.json"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 IR W 0x0 "Data signal of IR" {{0 16 IR W 0 "Bit 15 to 0 of IR"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 PC W 0x0 "Data signal of PC" {{0 16 PC W 0 "Bit 15 to 0 of PC"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 PC_out R 0x0 "Data signal of PC_out" {{0 16 PC_out R 0 "Bit 15 to 0 of PC_out"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 PC_out_ctrl R 0x0 "Control signal of PC_out" {{0 1 PC_out_ap_vld R 0 "Control signal PC_out_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 R0 R 0x0 "Data signal of R0" {{0 16 R0 R 0 "Bit 15 to 0 of R0"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 R0_ctrl R 0x0 "Control signal of R0" {{0 1 R0_ap_vld R 0 "Control signal R0_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 R1 R 0x0 "Data signal of R1" {{0 16 R1 R 0 "Bit 15 to 0 of R1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x44 R1_ctrl R 0x0 "Control signal of R1" {{0 1 R1_ap_vld R 0 "Control signal R1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 R2 R 0x0 "Data signal of R2" {{0 16 R2 R 0 "Bit 15 to 0 of R2"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x54 R2_ctrl R 0x0 "Control signal of R2" {{0 1 R2_ap_vld R 0 "Control signal R2_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 R3 R 0x0 "Data signal of R3" {{0 16 R3 R 0 "Bit 15 to 0 of R3"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x64 R3_ctrl R 0x0 "Control signal of R3" {{0 1 R3_ap_vld R 0 "Control signal R3_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x70 R4 R 0x0 "Data signal of R4" {{0 16 R4 R 0 "Bit 15 to 0 of R4"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 R4_ctrl R 0x0 "Control signal of R4" {{0 1 R4_ap_vld R 0 "Control signal R4_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x80 R5 R 0x0 "Data signal of R5" {{0 16 R5 R 0 "Bit 15 to 0 of R5"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x84 R5_ctrl R 0x0 "Control signal of R5" {{0 1 R5_ap_vld R 0 "Control signal R5_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x90 R6 R 0x0 "Data signal of R6" {{0 16 R6 R 0 "Bit 15 to 0 of R6"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x94 R6_ctrl R 0x0 "Control signal of R6" {{0 1 R6_ap_vld R 0 "Control signal R6_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xa0 R7 R 0x0 "Data signal of R7" {{0 16 R7 R 0 "Bit 15 to 0 of R7"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xa4 R7_ctrl R 0x0 "Control signal of R7" {{0 1 R7_ap_vld R 0 "Control signal R7_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xb0 N R 0x0 "Data signal of N" {{0 16 N R 0 "Bit 15 to 0 of N"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xb4 N_ctrl R 0x0 "Control signal of N" {{0 1 N_ap_vld R 0 "Control signal N_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xc0 Z R 0x0 "Data signal of Z" {{0 16 Z R 0 "Bit 15 to 0 of Z"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xc4 Z_ctrl R 0x0 "Control signal of Z" {{0 1 Z_ap_vld R 0 "Control signal Z_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xd0 P R 0x0 "Data signal of P" {{0 16 P R 0 "Bit 15 to 0 of P"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xd4 P_ctrl R 0x0 "Control signal of P" {{0 1 P_ap_vld R 0 "Control signal P_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xe0 n1 R 0x0 "Data signal of n1" {{0 16 n1 R 0 "Bit 15 to 0 of n1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xe4 n1_ctrl R 0x0 "Control signal of n1" {{0 1 n1_ap_vld R 0 "Control signal n1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0xf0 p1 R 0x0 "Data signal of p1" {{0 16 p1 R 0 "Bit 15 to 0 of p1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0xf4 p1_ctrl R 0x0 "Control signal of p1" {{0 1 p1_ap_vld R 0 "Control signal p1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x100 z1 R 0x0 "Data signal of z1" {{0 16 z1 R 0 "Bit 15 to 0 of z1"} {16 16 RESERVED R 0 "Reserved.  0s on read."}}} {0x104 z1_ctrl R 0x0 "Control signal of z1" {{0 1 z1_ap_vld R 0 "Control signal z1_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
source -notrace "F:/Vitis_HLS/2023.2/common/scripts/ipxhls.tcl"
set outdir .
