...
HD_PWD='C:/Users/phat6/OneDrive/Desktop/testnaykia/example/example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_2b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_2b.tcl
