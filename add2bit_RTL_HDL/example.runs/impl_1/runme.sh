...
HD_PWD='C:/Users/phat6/OneDrive/Desktop/testnaykia/example/example.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_2b.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_2b.tcl -notrace
