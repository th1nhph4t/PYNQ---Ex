...
set xo_kernel_name "ALU"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "C:/Users/phat6/OneDrive/Desktop/testnaykia/vitis/alut/alu/solution1"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "C:/Users/phat6/OneDrive/Desktop/testnaykia/vitis/alut/alu/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {ALU_control_s_axi
ALU
}
set kernel_xo ""
set detect_deadlock_json "ALU_message_dict.json"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 of a"}}} {0x18 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 of b"}}} {0x20 op W 0x0 "Data signal of op" {{0 32 op W 0 "Bit 31 to 0 of op"}}} {0x28 result R 0x0 "Data signal of result" {{0 32 result R 0 "Bit 31 to 0 of result"}}} {0x2c result_ctrl R 0x0 "Control signal of result" {{0 1 result_ap_vld R 0 "Control signal result_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
