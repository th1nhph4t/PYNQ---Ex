...
architecture behave of ALU_control_s_axi is
    ...
    constant ADDR_RESULT_DATA_0 : INTEGER := 16#28#;
    constant ADDR_RESULT_CTRL   : INTEGER := 16#2c#;
